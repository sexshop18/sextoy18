...
<form name="supplier" id="validate" class="form" action="index.php?com=company&act=save" method="post" enctype="multipart/form-data">
    ...
    <div class="widget">
        ...
        <div class="formRow">
            <label>Phân trang index</label>
            <div class="formRight">
                <input type="text" value="<?= @$item['tiwtter'] ?>" name="tiwtter" title="Nhập phân trang index" class="tipS" />
            </div>
            <div class="clear"></div>
        </div>
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                <input type="text" value="<?= @$item['skype'] ?>" name="skype" title="Nhập phân trang" class="tipS" />
            </div>
            <div class="clear"></div>
        </div>	
        <div class="formRow">
            <label>PT Sản phẩm cùng loại</label>
            <div class="formRight">
                <input type="text" value="<?= @$item['yahoo'] ?>" name="yahoo" title="Nhập phân trang" class="tipS" />
            </div>
            <div class="clear"></div>
        </div>	
