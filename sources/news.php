<?php  if(!defined('_source')) die("Error");
	...
	{
		#Chi tiết tin tức
		$sql = "select ten$lang as ten,id,mota$lang as mota,noidung$lang as noidung,title,keywords,description,photo from #_news where id='".$id."' limit 0,1";
		$d->query($sql);
		...
		$sql_hinhkhac = "select id,ten,thumb,photo from #_hinhanh where type='".$type."' and hienthi=1 and id_hinhanh='".$id."' order by stt,id desc";
	...
	$page = $_GET['p'];
	$pageSize = 10;//Số item cho 1 trang
