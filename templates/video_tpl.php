...
<script type="text/javascript">
	$(document).ready(function(e) {
        $('a.xem_video').click(function(){
			...
			$('body').append('<div class="login-popup"><div class="close-popup">x</div><div class="video_popup"><iframe width="700px" height="400px" src="https://www.youtube.com/embed/'+link_viveo+'?rel=0" frameborder="0" allowfullscreen></iframe></div></div>');
